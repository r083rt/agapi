...
<html lang="en">
  <head>
    ...
    <title>Pemetaan Jumlah Guru Bersertifikasi dan Belum Sertifikasi</title>
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item {{request()->is('pemetaan_provinsi*')?'active':''}}">
            <a class="nav-link" href="/pemetaan_provinsi">Pemetaan Berdasarkan Provinsi <span class="sr-only">(current)</span></a>
          </li>
