...
where 
	exists(select 1 from assigment_types where id=assigment_type_id and `description`='selectoptions') AND #hanya memilih soal yang uraian/teks
	a.user_id=aql.creator_id
    AND a.is_publish=0 
    -- and aql.question_list_id=54460
