...
class CityDistrictNonPnsMemberController extends Controller
{
    /**
    ...
    {
        //ambil district berdasarkan city id dengan total users yang is_pns = 0 dan user_activated_at != null
