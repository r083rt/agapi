...
Route::group(['prefix' => 'v1', 'namespace' => 'API\\v1'], function () {
    ...
    Route::group(['middleware' => [
        ...
        Route::get('/assigments/questionlists/search/{subjectId}/{educationalLevelId}', 'AssigmentController@buildSearch');
        ...
        Route::get('/lessonplans/search/{key}/{educational_level_id?}', 'LessonPlanController@searchbykey'); // SEARCH LESSONPLAN BY GIVEN KEY
