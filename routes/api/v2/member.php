...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::resources([
        ...
        'city.pension-user' => 'CityPensionUserController', // untuk mengambil anggota pensiun berdasarkan kota
        'district' => 'DistrictController', // untuk mengambil kecamatan
        'district.pension-user' => 'DistrictPensionUserController', // untuk mengambil anggota pensiun berdasarkan kecamatan
